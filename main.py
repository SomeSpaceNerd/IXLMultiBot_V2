...
PATH = ('C:\\Users\\Will\\Downloads\\chromedriver-win64(1)\\chromedriver-win64\\chromedriver.exe') 
...
def main4(argv):
	...
	while True:
		...
		driver.refresh()
		time.sleep(4)
		q1 = driver.find_element(By.CLASS_NAME, 'yui3-practiceagent-content')
		q2 = q1.text
		print(repr(q2))
		driver.find_element(By.XPATH, '/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[1]/div/div[2]/button').click()
		time.sleep(4)
		driver.find_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div/button[2]').click()
		time.sleep(4)
		#change this
		answer = driver.find_element(By.XPATH,'/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[8]/div/div[1]/div[4]/div[2]/div/div/div[2]')
		ans = answer.text
		print(ans)
		driver.delete_all_cookies()
		driver.find_element(By.XPATH,'/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[8]/div/div[1]/div[1]/div[2]/button').click()
...
def main1(argv):
	...
	while True:
		...
		time.sleep(4)
		#change this
		answer = driver.find_element(By.XPATH,'/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[8]/div/div[1]/div[4]/div[2]/div/div/div/div/div[9]')
		ans = answer.text
		print(ans)
		driver.delete_all_cookies()
		driver.find_element(By.XPATH,'/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[8]/div/div[1]/div[1]/div[2]/button').click()
...
def main2(argv):
	...
	while True:
		...
		driver.find_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div/button[2]').click()
		time.sleep(4)
		answer = driver.find_element(By.XPATH,'/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[8]/div/div[1]/div[4]/div[2]/div/div/div/div/div')
		ans = answer.text
		print(ans)
		driver.delete_all_cookies()
		driver.find_element(By.XPATH,'/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[8]/div/div[1]/div[1]/div[2]/button').click()
...
def main3(argv):
	...
	while True:
		...
		driver.find_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div/button[2]').click()
		time.sleep(4)
		answer = driver.find_element(By.XPATH,'/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[8]/div/div[1]/div[4]/div[2]/div/div/div/div')
		ans = answer.text
		print(ans)
		driver.delete_all_cookies()
		driver.find_element(By.XPATH,'/html/body/div[9]/section/div[1]/div[1]/div[6]/div/div[8]/div/div[1]/div[1]/div[2]/button').click()
...
def op1():
    ...
    time.sleep(3)
    driver.refresh()
    driver.find_element(By.ID, 'qlusername').send_keys(username) ## UNCOMMENT IF LOGGED OUT
    driver.find_element(By.ID, 'qlpassword').send_keys(password) ## UNCOMMENT IF LOGGED OUT
    driver.find_element(By.ID, 'qlsubmit').click() ## UNCOMMENT IF LOGGED OUT
    ...
    while True:
        ...
        inarray = variable.split(' ')
        inarrayfixed = [inarray[0].replace('–', '-'), inarray[2].replace('–', '-')]
        answer = int(inarrayfixed[0]) + int(inarrayfixed[1])
        a = (answer)
        print(a)
        driver.switch_to.window(driver.window_handles[0])
        driver.find_element(By.CLASS_NAME,'fillIn').click()
        driver.find_element(By.CLASS_NAME,'fillIn').send_keys(a)
        time.sleep(150) #Generates precious TIME!!!!!!!!!
